  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-neutral-950 disabled:pointer-events-none disabled:opacity-50 dark:focus-visible:ring-neutral-300",
  {
    variants: {
      variant: {
        ...
        omenkuning:
          "font-popins border-black border-2 bg-kuning hover:bg-yellow-400 transition-colors",
        omenputih:
          "font-popins border-black border-2 bg-white hover:bg-yellow-400 transition-colors",
        omenijo:
          "font-popins border-black border-2 bg-ijo hover:bg-yellow-400 transition-colors",
        destructive:
